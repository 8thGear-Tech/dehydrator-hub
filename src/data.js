...
export const whyWork= [
  ...
  export const testimonials = [
    {
      imgSrc: testimony2,
      quote: "Dehydrator Hub has been a part of our journey for several years supplying us with the best quality machines and equipment. There’s nothing I ask for she can’t get for me.",
      name: "Dr Olofoyeku",
      title: "Useful Herbs",
    },
    {
  ...
  export const blogPosts = [
    {
      id:1,
      blogImage: blog1,
      blogText: "We've all experienced the chaos of multiple spreadsheets, tracking and insight tools...",
      blogHeading: "A small business is only as good as its tools and it is totally true.",
      blogName:'John Doe',
...
export const dehydrationMachine = [
    ...
    productPictures:[dehydratingMachine,dehydratingMachine, dehydratingMachine,dehydratingMachine, dehydratingMachine],
