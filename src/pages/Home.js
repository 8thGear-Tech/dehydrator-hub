        ...
        <div>
          ...
          <section className="my-3 my-md-5">
              ...
              {millableProducts.map((product) => (
                <Col xs={6} md={3} key={product.id} className="mb-3">
                  <Card
                    ...
                    onClick={() => handleProductClick(product?.id, "millable")}
                    className="h-100"
                  >
                    <div
            ...
            <div className="text-center mt-3 mb-5">
              <Button className="btn-primary " style={{ width: "230px" }}>
                Request Service
              </Button>
            </div>
          </section>
            ...
            <Row>
              {hydrationProducts.map((product) => (
                <Col xs={6} md={3} key={product.id} className="mb-3">
                  <Card
                    style={{ borderRadius: "16px" }}
                    onClick={() => handleProductClick(product?.id, "hydration")}
                    className="h-100"
                  >
                    <div
                      className="p-2 p-md-4"
          ...
          <Row>
            {processingRates.map((product) => (
              <Col xs={12} md={6} key={product.id} className=" mb-4 mb-md-3">
                <Card
                  style={{ borderRadius: "16px", border: "1px solid #DEE2E7" }}
