      ...
      <div className='px-3 px-md-5 mx-lg-4'>
        ...
        {carouselHero.map((item)=>(
          <Carousel.Item key={item.id}>
            ...
            <Card.Img src={hero1} alt='hero1' style={{minHeight:'300px',maxHeight:'380px'}}/>
        ...
        <section className="my-3 my-md-5 py-5 px-lg-5">
          <Card className="border-0">
            ...
            <Card.ImgOverlay className='px-3 py-5 px-md-5' style={{maxWidth:'37rem', color:'#ffffff'}}>
              ...
              <h5 className='mt-3 me-5'style={{ color:'#ffffff', fontWeight:'400'}}>Do you have idle capacity for your processing equipment, put you machines to optimal use.
              <br/> List with Dehydrator Hub today!</h5>
