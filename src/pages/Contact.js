...
const Contact = () => {
  return (
    ...
    <i className="bi bi-chevron-right" style={{fontSize:'0.8rem'}}></i>
      ...
      <section style={{backgroundColor:'#F5F5F5'}} className='position-relative'>
       
        <div className='py-5 px-4 px-lg-5 position-relative'>
        <img  src={line1} alt='line' className='d-none d-md-flex position-absolute' style={{top:'-6%', left:"-4%"}}/>
        <img  src={line2} alt='line' className='d-none d-md-flex  position-absolute' style={{bottom:'0%', left:"-6%"}}/>
          <div className='text-center mb-5'>
            <h2 style={{fontWeight:'400'}}>Say hello</h2>
            <p className='my-2' style={{color:'#777777'}}>Lorem Ipsum is simply dummy text of the printing .</p>
          ...
          <Row>
            ...
            <Form.Label style={{color:'#5D5D5D'}}>First Name</Form.Label>
            <Form.Control
            type="text"
            name="firstName"
            id="firstName"
          ...
          />
            ...
            <Col xs={12} md={6}>
            <Form.Group className='mb-3'>
            <Form.Label style={{color:'#5D5D5D'}}>Last Name</Form.Label>
            <Form.Control
            type="text"
            name="lastName"
            id="lastName"
          ...
          />
            ...
            <div className='mt-4 d-flex justify-content-end'><Button type='submit' className='btn-primary p-3'> Get in touch</Button></div>
