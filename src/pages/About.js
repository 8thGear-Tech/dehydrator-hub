    ...
    <Col xs={12} md={4} key={work.id} className="mb-3">
      ...
      <section style={{backgroundColor:'#F5F5F5'}} className="mb-5 p-md-5">
        <Row className="px-lg-5">
          ...
          <Col xs={12} md={8} className="mb-3">
            <div className="d-flex flex-column gap-2 ps-3 pe-4 px-md-5 " style={{maxWidth:'34rem'}}>
              <h6 style={{fontWeight:'500', color:'#81AC29'}}>Lorem ipsum</h6>
              <h3 style={{fontWeight:'600', lineHeight:'34px'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </h3>
              <h6 style={{lineHeight:'22px'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</h6>
            </div>
          </Col>
        </Row>
      </section>
      ...
      <Col xs={12} md={4} className="mb-3 px-2 px-md-0">
          ...
          <div className="position-relative px-3 text-center align-items-center justify-content-center" style={{ zIndex: 0 }}>
            ...
            {/* Decorative elements */}
            <div className="position-absolute" style={{ top: "-5%", left: '-5%', zIndex: 1 }}>
              <Image fluid src={points} alt=""/>
            </div>
            <div className="position-absolute" style={{ bottom: '-7%', right: '-3%', zIndex: 1,}}>
        ...
        <Col xs={12} md={8} className="mb-3 mt-3 mt-md-0">
          <div className="d-flex flex-column gap-3 gap-md-5 ps-3 pe-4 px-md-5 " style={{maxWidth:'34rem'}}>
            ...
            <div className="d-flex gap-3">
              <button className="btn btn-outline-secondary" onClick={goToPrevious} style={{borderRadius:'50%'}}><i className="bi bi-arrow-left"></i></button>
              <button className="btn btn-outline-secondary" onClick={goToNext} style={{borderRadius:'50%'}}><i className="bi bi-arrow-right"></i></button>
            </div>
          </div>
        </Col>
          {/* <Col xs={12} md={4} className="mb-3">
